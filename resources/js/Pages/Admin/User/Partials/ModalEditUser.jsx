        ...
        <Dialog open={open}>
            <DialogContent setOpen={setOpen} className="w-96">
                ...
                <div className="space-y-1">
                    ...
                    <Input name="username" id="username" value={data.username} onChange={onChange} />
                    <InputError errors={errors} fieldName={"username"} />
                </div>
                <div className="space-y-1">
                    <Label htmlFor="name" >Nama</Label>
                    <Input name="name" id="name" value={data.name} onChange={onChange} />
                ...
                <div className="mt-4">
                    <Button size="lg" variant="secondary" type="submit" disabled={processing} >
