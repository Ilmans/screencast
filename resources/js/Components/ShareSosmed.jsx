...
const socialMediaIcons = [
    {
        ...
        fill: "#3b5998",
        path: "M34.1,47V33.3h4.6l0.7-5.3h-5.3v-3.4c0-1.5,0.4-2.6,2.6-2.6l2.8,0v-4.8c-0.5-0.1-2.2-0.2-4.1-0.2c-4.1,0-6.9,2.5-6.9,7V28H24v5.3h4.6V47H34.1z",
    },
    {
        label: "twitter",
...
function ShareSosmed({ vertical = true }) {
    const currentUrl =
        typeof window !== "undefined" ? window.location.href : "";
    return (
        <div className={`flex flex-col gap-2 mt-4 sm:flex-row sm:items-center`}>
            {vertical && (
                <h4 className="flex items-center justify-start w-20 h-8 pl-4 font-semibold text-white rounded-l-full bg-gradient-to-r from-violet-700 to-transparent via-primary-500">
                    Share
                </h4>
            )}
            <div
                ...
                } items-center gap-2 [&>button>svg]:h-8 [&>button>svg]:w-8 [&>button>svg]:rounded-lg`}
            >
                {socialMediaIcons.map((icon) => (
                    <button
                        ...
                        onClick={() =>
                            window.open(
                                `${icon.shareUrl}${encodeURIComponent(
                                    currentUrl
                                )}`,
                                "_blank"
                            )
